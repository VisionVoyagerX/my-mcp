...
- **Παγκόσμιο rate limiting ξεχωριστό από το γενικό, ανά-IP limiter του worker.** Αντικατοπτρίζει το πραγματικό όριο 8 req/min/κλειδί της ΚΥ ΓΕΜΗ αντί να υποθέτει (λάθος) ότι είναι ανά χρήστη (§2.2).
